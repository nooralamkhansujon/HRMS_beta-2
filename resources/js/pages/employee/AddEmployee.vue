                         ...
                         <form>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" v-model="form.employee_name" name="employee_name" id="employee_name" class="form-control" placeholder="johndoe" />
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="form-label" for="email">Employee Departement</label>
                                    <input type="text" name="employee_department" id="employee_department" class="form-control"
                                    v-model="form.employee_department" placeholder="department" aria-label="john.doe" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text"
                                     v-model="form.employee_designation" name="employee_designation" id="employee_designation" class="form-control"
                               ...
                               <div class="form-group col-md-6 ">
                                    <div class="custom-control custom-checkbox mt-2">
                                        ...
                                        class="custom-control-input" type="checkbox"
                                          v-model="form.employee_status"  id="employee_status"  tabindex="3" />
                                        <label class="custom-control-label" for="employee_status"> Employee Status </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-md-6">
                                    ...
                                    <input
                                     ...
                                     id="employee_image" class="form-control" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-md-6">
                                    <label class="form-label" for="emergency_mobile_number">Emergency Mobile Number</label>
                                    <input type="text"
                                      v-model="form.emergency_mobile_number"
                                      name="emergency_mobile_number" id="emergency_mobile_number" class="form-control"  placeholder="Emergency mobile number"  />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        v-model="form.email"
                                        type="email" name="email" id="email" class="form-control" placeholder="Enter Email"
                                     />
                                </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6 form-group">
                                    ...
                                    <input
                                       ...
                                       type="text" id="religion" class="form-control" placeholder="Religion"
                                    />
                                </div>
                            </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6 form-group">
                                    ...
                                    <input
                                        ...
                                        type="text" name="bank_account_number" id="bank_account_number" class="form-control" placeholder="Bank Name" />
                                </div>
                            </div>
                            <!-- blood_group and gender -->
                            <div class="row">
                              ...
                              <div class="col-md-6 form-group">
                                    <label class="form-label" for="permanent_address">Permanent Address</label>
                                     <textarea
                                      ...
                                      class="form-control" id="permanent_address" name="permanent_address" rows="3" placeholder="Permanent Address"></textarea>
                                </div>
                                 ...
                                 <div class="col-md-6 form-group">
                                    <label class="form-label" for="present_address">present Address</label>
                                     <textarea
                                          ...
                                          class="form-control" id="present_address" name="present_address" rows="3" placeholder="present Address">
                                    </textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label class="form-label" for="weekly_off_day">
                                        Weekly Off day
                                    </label>
                                    <select
                                       v-model="form.weekly_off_day"
                                        class="custom-select" name="weekly_off_day" id="customSelect">
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="form-label" for="education_level">Last Education Level</label>
                                    <input
                                      v-model="form.education__eduction_level"
                                      type="text"
                                      name="education_level" id="education_level" class="form-control"
                                       placeholder="Last Education Level" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <label class="form-label" for="major_group">Education Major Group</label>
                                    <input
                                          v-model="form.education__major_group"
                                          type="text"
                                          name="major_group"
                                          id="major_group" class="form-control" placeholder="Education Major Group"
                                     />
                                </div>

                                <div class="col-md-6 form-group">
                                    <label class="form-label" for="result_type">Education Result Type</label>
                                    <input
                                       v-model="form.education__result_type"
                                        type="text"
                                        name="result_type"
                                        id="result_type"
                                        class="form-control" placeholder="Education Result Type" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input
                                         ...
                                         name="result"
                                         id="result"
                                         class="form-control" placeholder="Education Result" />
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="form-label" for="passing_year">Education Passing Year </label>
                                    <input
                                         v-model="form.education__passing_year"
                                         type="text" name="passing_year" id="passing_year" class="form-control" placeholder="Education Passing Year" />
                                </div>
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="form-label" for="achievement">Education  Achievement </label>
                                    <textarea
                                        v-model="form.education__achievement"
                                        class="form-control"
                                        id="achievement"
                                         name="achievement" rows="3" placeholder="Achievement">
                                    </textarea>
                                </div>
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="form-label" for="name">Relative Name </label>
                                     <input
                                          ...
                                          name="relative_name"
                                          id="relative_name"
                                           class="form-control" placeholder="Relative Name" />
                                </div>
                                <div class="col-md-6 form-group">
                                     ...
                                     <input
                                        ...
                                        type="text"
                                        name="relation_type"
                                        id="relation_type" class="form-control" placeholder="Relation Type" />
                                </div>
                             ...
                             <div class="row">
                                 <div class="col-md-6 form-group">
                                     ...
                                     <textarea
                                        ...
                                        name="reladdress"
                                        id="reladdress"
                                        class="form-control" placeholder="Relative Address"></textarea>
                                </div>
                                 <div class="col-md-6 form-group">
                                     <label class="form-label" for="relcontact_number">Relative Contact Number</label>
                                     <input
                                         v-model="form.relative__contact_number"
                                        type="text"
                                        name="relcontact_number" id="relcontact_number" class="form-control" placeholder="Relative Contact Number" />
                                </div>
                             ...
                             <div class="row">
                                  <div class="col-md-6 form-group">
                                     ...
                                     <input
                                      ...
                                      type="text" name="name" id="name" class="form-control" placeholder="Reference Name" />
                                </div>
                                <div class="col-md-6 form-group">
                                     <label class="form-label" for="organization">Reference Organization</label>
                                     <input
                                        v-model="form.reference__organization"
                                        type="text" name="organization" id="organization" class="form-control" placeholder="Reference Organization" />
                                </div>
                             ...
                             <div class="row">
                                <div class="col-md-6 form-group">
                                     ...
                                     <input
                                        ...
                                        type="text"
                                        name="relation"
                                        id="refrelation" class="form-control" placeholder="Reference Relation" />
                                </div>
                                <div class="col-md-6 form-group">
                                     <label class="form-label" for="refaddress">Reference ref</label>
                                    <textarea
                                      v-model="form.reference__address"
                                     class="form-control" id="refaddress" name="refaddress" rows="3" placeholder="Reference address"></textarea>
                                </div>
                            ...
                            <div class="row">
                                  <div class="col-md-6 form-group">
                                     ...
                                     <input
                                         ...
                                         type="text" name="refemail" id="refemail" class="form-control" placeholder="Reference Email"
                                     />
                                </div>
                                <div class="col-md-6 form-group">
                                     <label class="form-label" for="refphone_number">Reference Phone Number</label>
                                     <input
                                       v-model="form.reference__phone_number"
                                       type="text"
                                       name="refphone_number" id="refphone_number" class="form-control" placeholder="Reference Phone Number" />
                                </div>
                            </div>
                        </form>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        name="training_title" id="training_title" class="form-control" placeholder="Training Title" />
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        v-model="form.training__topics_covered"
                                            type="text"
                                            name="topics_covered" id="topics_covered" class="form-control"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        name="institute"
                                        id="institute" class="form-control" placeholder="Training Institute" />
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="form-label" for="training_type">
                                        Training Type
                                    </label>
                                    <input
                                        ...
                                        name="training_type"
                                        id="training_type"
                                        class="form-control" placeholder="Training training Type" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        name="country"
                                        id="country" class="form-control" placeholder="Training Country" />
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        name="location"
                                        id="location"
                                        class="form-control" placeholder="Training Location" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label class="form-label" for="training_year">
                                        Training Year
                                    </label>
                                    <input
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        name="duration"
                                        class="form-control flatpickr-range flatpickr-input active" placeholder="YYYY-MM-DD to YYYY-MM-DD" readonly="readonly">
                                </div>
                            </div>
                        </form>
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        id="department"
                                        name="department" class="form-control" placeholder="Department" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        id="position_held"
                                        name="position_held" class="form-control" placeholder="Position Held" />
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="form-label" for="responsibility">Responsibility</label>
                                    <textarea
                                         v-model="form.experience__responsibility"
                                         id="responsibility" name="responsibility" class="form-control" placeholder="Responsibility">
                                    </textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                   ...
                                   <textarea
                                        v-model="form.experience__experience_area"
                                         id="experience_area" name="experience_area" class="form-control" placeholder="Experience Area"></textarea>
                                </div>
                                <div class="form-group col-md-6">
                                   ...
                                   <input
                                    ...
                                    type="text"
                                    class="form-control flatpickr-basic flatpickr-input" name="from_date" placeholder="YYYY-MM-DD" readonly="readonly">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                  ...
                                  <input
                                     ...
                                     type="text"
                                     class="form-control flatpickr-basic flatpickr-input"
                                     name="to_date" placeholder="YYYY-MM-DD" readonly="readonly">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="form-label" for="company_address">Company Address</label>
                                    <textarea
                                     v-model="form.experience__company_address"
                                     id="company_address" name="company_address" class="form-control" placeholder="Company Address"></textarea>
                                </div>
                            </div>
                        </form>
                        <div class="d-flex justify-content-between">
                        ...
                        <form>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    type="text" id="promemployee_name" name="promemployee_name" class="form-control" placeholder="Employee Name" />
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="form-label" for="fp-default">Promotoion Date</label>
                                        <input
                                            v-model="form.promotion__promotion_date"
                                            type="text"  name="promdate"
                                            class="form-control flatpickr-basic flatpickr-input"
                                            placeholder="YYYY-MM-DD" readonly="readonly">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label class="form-label" for="previous_designation">Previous Designation</label>
                                    <input
                                        v-model="form.promotion__previous_designation"
                                        type="text" id="previous_designation" class="form-control" name="previous_designation" placeholder="Previous Designation" />
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                            ...
                                            type="text"
                                            id="new_designation" class="form-control" placeholder="New Designation" name="new_designation" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                            ...
                                            type="text"
                                            id="previous_grade" class="form-control" name="previous_grade" placeholder="Previous Grade" />
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                            ...
                                            type="text"
                                            id="new_degree"
                                            name="new_degree" class="form-control" placeholder="New Degree" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label class="form-label" for="previous_promotion_date">Previous Promotion Date</label>
                                        <input
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        id="previous_basic" name="previous_basic" class="form-control" placeholder="Previous Previous salary" />
                                </div>
                            </div>
                            <div class="row">
                                    <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        id="new_basic"
                                        name="new_basic"
                                        class="form-control" placeholder="New salary" />
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        type="text"
                                        id="previous_gross" name="previous_gross" class="form-control" placeholder="Previous Gross" />
                                </div>
                            </div>
                            <div class="row">
                                    <div class="form-group col-md-6">
                                    ...
                                    <input
                                        ...
                                        type="text" id="new_gross" name="new_gross"
                                        class="form-control" placeholder="new Gross"
                                        />
                                </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <input
                                            ...
                                            type="text" id="increment_amount" name="increment_amount" class="form-control" placeholder="Increment Amount" />
                                </div>
                            ...
                            <div class="row">
                                    ...
                                    <label class="form-label" for="effect_date">Effect Date</label>
                                        <input
                                            ...
                                            id="effect_date"
                                            class="form-control flatpickr-basic flatpickr-input"
                                            name="effect_date" placeholder="YYYY-MM-DD" readonly="readonly"
                                        />
                                </div>
                            </div>
                      </form>
